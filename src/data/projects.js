const projects = [
  ...
  },
  {
    ...
    desc_long: [
      ...
      'I drew the full design in Affinity Studio and then set up the project with Vite. I decided to use React, since I knew there would be many repeatable patterns and I wanted to structure the project to be as modular as possible. For animations I chose to use Motion.dev (ex. Framer Motion), because of its close integration with React.',
      'I incorporated some of my favourite projects into the site design. My favourite p5 experiment was the Ant, an attemp of creating styled agentic behaviour, inspired by the famous coding series by Daniel Shiffman. I also included a modified algorithm for the most famous cellular automaton of all time: the Game of Life by John Conway.',
      'In the end, I optimized the site to ensure the smoothest possible experience. I used the Imagetools plugin to reduce project assets by >95% using efficient modern image codecs, and generate smaller thumbnails for preview. I also migrated p5 code to q5 for better performance at a fraction of the bundle size. Using smart image preloading I ensured all images are loaded immediately with no layout shifts and weird glitching. Together, these improvements enabled me to achieve near perfect Google Lighthouse score.',
    ],
    tags: ['React', 'Vite', 'Motion.dev', 'Affinity Studio', 'SEO'],
    category: 'Frontend',
    color: '#FFDBCC',
  },
  {
